    ...
    instance.get(`/${cardId}`, config)
        ...
        `
            ...
            editSave.addEventListener('click', () => {
                ...
                let formAge = parseInt(document.querySelector('input[form-name = "age"]').value)
                let formWeight = parseInt(document.querySelector('input[form-name = "weight"]').value)
                if (isNaN(formAge) ||  isNaN(formWeight) ||  isNaN(formBP)){
                    Notify.warning('Введіть коректні дні (вік, вага, тиск мають бути числом')
                } else {
                    let newCard = {}
